...
![descrição da imagem](https://github.com/priscilaSartori/project-playground-functions/blob/main/Playground.png)
...
Implementação do código de funções que resolvem problemas com respostas pré-determinadas utilizando a lógica de programação para na análise de cada problema e resposta esperada, facilitando a implementação do código de cada uma das funções.
...
- Clone este repositório: `git clone git@github.com:priscilaSartori/project-playground-functions.git`

- Acesse a pasta do projeto no terminal/cmd: `cd project-playground-functions`

- Instale as dependências: `npm install`

- Teste o projeto: `npm test`
